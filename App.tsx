...
import GrowthChartScreen from './components/GrowthChartScreen';
import ImunisasiScreen from './components/ImunisasiScreen';
import authService from './services/authService';

type Screen = 'welcome' | 'signup' | 'signin' | 'home' | 'konten' | 'chat' | 'profile' | 'product' | 'diari' | 'edit-profile' | 'change-password' | 'growth-chart' | 'imunisasi';
...
export default function App() {
  ...
  const handleNavigation = (screen: string) => {
    switch (screen) {
      ...
      case 'change-password':
        ...
        break;
      case 'growth-chart':
        setCurrentScreen('growth-chart');
        break;
      case 'imunisasi':
        setCurrentScreen('imunisasi');
        break;
      default:
        break;
    }
  ...
  const renderCurrentScreen = () => {
    switch (currentScreen) {
      ...
      case 'change-password':
        return <ChangePasswordScreen onBack={() => setCurrentScreen('profile')} onNavigate={handleNavigation} />;
      case 'growth-chart':
        return <GrowthChartScreen onBack={() => setCurrentScreen('home')} />;
      case 'imunisasi':
        return <ImunisasiScreen onBack={() => setCurrentScreen('home')} />;
      default:
