...
// Menggunakan hosting production
const API_BASE_URL = 'https://mediumslateblue-quail-329197.hostingersite.com/api';
const BASE_URL = 'https://mediumslateblue-quail-329197.hostingersite.com';
