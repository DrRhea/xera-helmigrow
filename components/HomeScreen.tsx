          ...
          <View style={styles.childrenListContainer}>
            <View style={styles.childrenList}>
              {childrenData.map((child) => {
                // Calculate age from birth_date using utility function
                const ageInMonths = calculateAgeInMonths(child.birth_date);
                const ageText = formatAge(ageInMonths);
                  ...
                  >
                    <View style={styles.childListItemContent}>
                      <View style={styles.childAvatarContainer}>
                        {child.profile_image && child.profile_image.trim() !== '' ? (
                          <Image
                            source={{ 
                              uri: child.profile_image.startsWith('data:') || child.profile_image.startsWith('http') || child.profile_image.startsWith('file://')
                                ? child.profile_image 
                                : getImageUrl(child.profile_image) || child.profile_image
                            }}
          ...
          >
            <View style={styles.manjujaiContent}>
              ...
              <View style={styles.manjujaiText}>
                ...
                <Text style={styles.manjujaiSubtitle}>Konten Edukasi Manjujai</Text>
              </View>
