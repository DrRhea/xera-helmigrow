...
const ArtikelScreen: React.FC<ArtikelScreenProps> = ({ onBack }) => {
      ...
      >
        ...
        <View style={styles.cardContent}>
          ...
          <View style={styles.cardFooter}>
            ...
            <View style={styles.metaInfo}>
              <Ionicons name="calendar-outline" size={14} color="#FF6B9D" />
      ...
      <View style={styles.filterSection}>
        ...
        >
          <TouchableOpacity style={[styles.filterButton, styles.activeFilter]}>
            <Text style={[styles.filterText, styles.activeFilterText]}>Semua</Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.filterButton}>
            <Text style={styles.filterText}>Kesehatan</Text>
          </TouchableOpacity>
        </ScrollView>
      </View>
