    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.headerContent}>
          ...
          <View style={styles.headerCenter}>
            <Image
              ...
              resizeMode="contain"
            />
            <Text style={styles.headerTitle}>HelmiGrowth</Text>
          </View>
        ...
        <View style={styles.childInfo}>
          ...
          <Text style={styles.childDescription}>Keterangan {childData.name}</Text>
        </View>
      </LinearGradient>
          ...
          <View style={styles.perkembanganCard}>
            <View style={styles.perkembanganContent}>
              <View style={styles.perkembanganImageContainer}>
                <Image
                  source={require('../assets/icons/ikon-bayi.png')} // Placeholder untuk gambar dokter dan bayi
                  style={styles.perkembanganImage}
                  resizeMode="cover"
                />
              </View>
              <View style={styles.perkembanganTextContainer}>
                <Text style={styles.perkembanganTitle}>Perkembangan</Text>
                <Text style={styles.perkembanganSubtitle}>Stimulasi Anak Berdasarkan Umur</Text>
